pipeline {
 ...
 { steps {
		...
		sh 'aws cloudformation create-stack --stack-name simple-react-app-v${BUILD_NUMBER} --template-body file://stack.yaml --region us-east-1 --parameters  ParameterKey=SSHKey,ParameterValue=EC2 ParameterKey=ELBVPC,ParameterValue=vpc-9d0beee0 ParameterKey=ELBSubnet,ParameterValue="subnet-46f57748\\,subnet-56fd2809"'
        }
 }
 }
